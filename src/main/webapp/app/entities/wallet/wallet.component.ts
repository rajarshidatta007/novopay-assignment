...
export class WalletComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.walletService
      ...
      .subscribe(
        (res: HttpResponse<IWallet[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInWallets(): void {
    this.eventSubscriber = this.eventManager.subscribe('walletListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IWallet[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
